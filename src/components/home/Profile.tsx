...
export default function Profile({ author, social, features, researchInterests, careerInterests }: ProfileProps) {
    ...
    return (
        ...
        >
            ...
            {/* Research Interests & Career Interests */}
            {(researchInterests && researchInterests.length > 0) || (careerInterests && careerInterests.length > 0) ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    {careerInterests && careerInterests.length > 0 && (
                        <div className="bg-neutral-100 dark:bg-neutral-800 rounded-lg p-4 hover:shadow-lg transition-all duration-200 hover:scale-[1.02]">
                            <h3 className="font-semibold text-primary mb-3">{messages.profile.careerInterests}</h3>
                            <div className="space-y-2 text-sm text-neutral-700 dark:text-neutral-500">
